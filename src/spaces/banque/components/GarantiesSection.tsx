// ============================================================================
// GarantiesSection.tsx — Banque: gestion des sûretés
// src/spaces/banque/components/GarantiesSection.tsx
...
export default function GarantiesSection({ dossierId, dossier, refresh }: GarantiesSectionProps) {
  ...
  const handleSave = () => {
    ...
    console.log("[GarantiesSection] ✅ Saved:", {
      dossierId,
      count: items.length,
      couvertureTotale: totalCouverture,
      ratioGarantieSurPret: ratioValue,
  ...
  if (!dossierId) {
    return <p className="text-sm text-slate-500">Sélectionnez un dossier depuis le tableau de bord.</p>;
  }
