...
// ✅ FIX: le hook appartient à l'espace sourcing, pas à /src/hooks
...
const styles = {
  ...
  smartScoreIcon: {
    ...
    margin: "0 auto 16px",
    background:
      "linear-gradient(135deg, #e8f5e9 0%, #fff3e0 50%, #e3f2fd 100%)",
    borderRadius: "50%",
    display: "flex",
    alignItems: "center",
...
const Toast: React.FC<ToastProps> = ({ type, title, message, onClose }) => {
  ...
  return (
    <div
      style={{ ...styles.toast, ...(type === "error" ? styles.toastError : {}) }}
    >
    ...
    <div style={styles.summaryCard}>
      ...
      <div style={styles.summarySection}>
        ...
        <div style={styles.summaryRow}>
          ...
          <span
            style={form.codePostal ? styles.summaryValue : styles.summaryValueEmpty}
          >
            {form.codePostal || "-"}
          </span>
        </div>
        <div style={styles.summaryRow}>
          ...
          <span
            style={form.rueProche ? styles.summaryValue : styles.summaryValueEmpty}
          >
            {form.rueProche || "-"}
          </span>
        </div>
      ...
      <div style={styles.summarySection}>
        ...
        <div style={styles.summaryRow}>
          ...
          <span
            style={form.propertyType ? styles.summaryValue : styles.summaryValueEmpty}
          >
            {form.propertyType
              ? getPropertyTypeLabel(form.propertyType as PropertyType)
              : "-"}
          </span>
        </div>
        <div style={styles.summaryRow}>
        ...
        <div style={styles.summaryRow}>
          ...
          <span
            style={surface > 0 ? styles.summaryValue : styles.summaryValueEmpty}
          >
...
export const SourcingHomePage: React.FC<SourcingHomePageProps> = ({
  ...
  // ⚠️ dépend du hook réel: on garde ton API actuelle
    ...
    async (draft: SourcingItemDraft) => {
      ...
      if (result) {
        setToast({
          show: true,
          type: "success",
          title: `SmartScore: ${result.globalScore}/100`,
          message: result.globalRationale,
        });
      }
    },
