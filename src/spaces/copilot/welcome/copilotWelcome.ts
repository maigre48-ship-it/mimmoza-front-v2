...
export const COPILOT_HOME = {
  ...
  qa: [
    ...
    {
      key: 'copilot',
      q: "MimmozIA, c'est quoi ?",
      a: "Une fois une parcelle selectionnee dans un espace metier, MimmozIA repond a vos questions precises (zone PLU, reculs, hauteur, comparables...) et peut lancer des analyses. Ici, sur l'accueil, il n'y a pas encore de parcelle : je reste donc un guide.",
    },
  ] as ScriptedQA[],
};