...
/>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Section title="Étude de marché" icon={BarChart3}>
          ...
          <div className="space-y-0">
            ...
            <Row label="Transactions DVF" value={(marche.transactionsRecentes.nbTransactions > 0) ? 'Présentes (base DVF exploitée)' : 'NON RENSEIGNÉ'} highlight={(marche.transactionsRecentes.nbTransactions > 0)} missing={!(marche.transactionsRecentes.nbTransactions > 0)} />
      ...
      {syntheseIA && (<Section title="Synthèse analytique" icon={FileText} accent>
