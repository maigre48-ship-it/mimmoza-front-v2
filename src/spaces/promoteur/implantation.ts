...
/**
 * computeImplantationV1 � impl�mentation minimale "safe"
 * Objectif: ne pas casser l'UI, renvoyer un r�sultat coh�rent,
 * et une enveloppe apr�s reculs simple (buffer n�gatif).
 */
