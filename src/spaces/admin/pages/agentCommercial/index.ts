// src/spaces/admin/pages/agentCommercial/index.ts
// Barrel d'exports du module Agent commercial (importé par src/App.tsx).
...
export { AgentCommercialPipelinePage } from "./PipelinePage";
export { AgentCommercialKnowledgePage } from "./KnowledgePage";
export { AgentCommercialSettingsPage } from "./SettingsPage";
