...
interface LineForm {
  ...
  description: string;
  quantity: string;
  unit_price_ht_euros: string; // on saisit en euros, on convertit en centimes
}
    ...
    <div className="space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="mt-0.5 text-sm text-gray-500">Gérez vos devis et convertissez-les en factures.</p>
        </div>
        <button
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-100"
                  ...
                  >
                    <div className="col-span-4">
                      <input
                        ...
                        className="w-full rounded-md border border-gray-200 bg-white px-2 py-1.5 text-sm outline-none focus:border-indigo-400 focus:ring-1 focus:ring-indigo-100"
                      />
                    </div>
            ...
            <div className="flex justify-end">
              <div className="rounded-lg border border-gray-100 bg-gray-50 px-5 py-3 text-sm space-y-1 min-w-[220px]">
                ...
                {quotes.map((q) => (
                  <tr key={q.id} className="hover:bg-gray-50/60 transition-colors">
                    ...
                    <td className="px-4 py-3">
                      {isQuoteConverted(q) ? (
                        <span
                          className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium ${getQuoteStatusColor(q.status)}`}
                        >
                        ...
                        <div className="relative inline-block">
                          <select
                            ...
                            className={`appearance-none rounded-full px-2.5 py-0.5 pr-6 text-xs font-medium cursor-pointer border-0 outline-none ${getQuoteStatusColor(q.status)}`}
                          >
