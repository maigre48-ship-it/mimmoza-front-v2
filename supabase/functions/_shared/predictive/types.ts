...
export type PredictiveAnalysisSnapshot = {
  ...
  market: {
    ...
    /** Score de SÉCURITÉ, convention maison : 100 = zone très sûre, 0 = risque maximal. */
 ...
 *
 * `pinel` reste accepté en ENTRÉE parce que des snapshots enregistrés avant
 * septembre 2026 en contiennent encore. Le moteur ne lui accorde plus aucun
 * bonus : le dispositif est clos aux nouveaux investisseurs depuis le
 * 01/01/2025, et lui laisser une valorisation reviendrait à recommander
 * quelque chose qui n'est plus souscriptible.
 */
export type PredictiveRegime =
  | "lmnp_reel"
  | "lmnp_micro"
  | "nu"
  | "sci_ir"
...
export type PredictiveFiscalite = {
  ...
  /** Niveau de loyer conventionné, pour les dispositifs qui en dépendent. */
  niveauLoyer?: "intermediaire" | "social" | "tres_social";
  /** Travaux facturés, nécessaires au Jeanbrun ancien et au Denormandie. */
  travauxEur?: number;
  /** Intermédiation locative (Loc'Avantages) : ouvre les taux majorés. */
